...
(14, 'Mohammed', 'Taheer', '22', 'Male', 'Chintamani', 'Tankbund Road ', 'Taheer', 'Taheer@123');
...
select p.full_name, s.symptom_1, s.symptom_2, s.symptom_3, s.symptom_4, s.symptom_5, s.disease from patient_info p, sym_dis s where p.id_2 = s.id_2 and p.id = 41;
